...
输入的第一行包含 $N$。第二行包含 $N$ 个整数 $c_1, c_2, \dots, c_N$，其中 $c_i$ 是奶牛 $i$ 愿意支付的最高学费金额。
...
如果 Farmer John 收费 $4$，那么 $3$ 头奶牛将会入学，从而使他赚取 $3\cdot 4 = 12$ 的金额。

## 测试点性质

- 测试点 2-4 满足 $c_i \le 1{,}000$。
- 测试点 5-8 满足 $N \le 5{,}000$。
- 测试点 9-12 没有额外限制。
