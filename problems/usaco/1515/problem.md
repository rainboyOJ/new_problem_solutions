# 1515 Hoof Paper Scissors Minus One
...
在这个例子中，这对应于原始的蹄子剪刀布，我们可以设蹄子为 1，布为 2，剪刀为 3。 布战胜蹄子，蹄子战胜剪刀，剪刀战胜布。Bessie 无法确保战胜蹄子+布或布+剪刀的组合。然而，如果 Elsie 出蹄子+蹄子，Bessie 可以采用以下任一组合进行反击。
- 布+布
- 布+剪刀
- 布+蹄子
- 蹄子+布
