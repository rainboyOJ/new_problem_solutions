...
void init(){
    ...
    char tmp[100];
    for (i=1;i<=3;i++){
        std::cin >> cmp[i].left+1;
        std::cin >> cmp[i].right+1;
        std::cin >> tmp;
        if( tmp[0] == 'e')
            cmp[i].res =0;
        else if ( tmp[0] == 'u')
    ...
    while (n--) {
        ...
        for(i='A';i<='L';i++){
            ...
            if( compare_function(1)&&
                    compare_function(2)&&
                    compare_function(3) ) {
                std::cout << (char)(i) << " is the counterfeit coin and it is light.\n";
                break;
            }
            ...
            if( compare_function(1)&&
                    compare_function(2)&&
                    compare_function(3) ) {
                std::cout << (char)(i) << " is the counterfeit coin and it is heavy.\n";
                break;
            }
