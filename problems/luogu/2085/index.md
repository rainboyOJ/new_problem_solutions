...
1. 函数单调性：
   ...
   题目给出的函数是 $F_i(x)=A_ix^2+B_ix+C_i$。由于 $A_i, B_i, C_i \geqslant 0$ 且 $A_i \geqslant 1$，当 $x \geqslant 1$ 时，这些函数都是单调递增的。
...
- **数据规模**：$n, m \leqslant 10000$，总计算量约为 $10^5$ 级别，远低于时间限制，可以瞬间完成。

### 5. 数据范围注意事项

- $A_i \leqslant 10, B_i \leqslant 100, C_i \leqslant 10000$。
