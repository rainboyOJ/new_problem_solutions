...
设水平线段为 $y = Y_h, x \in [X_{h1}, X_{h2}]$ (保证 $X_{h1} \leqslant X_{h2}$)。 设垂直线段为 $x = X_v, y \in [Y_{v1}, Y_{v2}]$ (保证 $Y_{v1} \leqslant Y_{v2}$)。

它们相交的充要条件是：

1. 垂直线段的 $X$ 坐标在水平线段的 $X$ 范围内：$X_{h1} \leqslant X_v \leqslant X_{h2}$
2. 水平线段的 $Y$ 坐标在垂直线段的 $Y$ 范围内：$Y_{v1} \leqslant Y_h \leqslant Y_{v2}$
...
**相交判断**：
*   **线段1 (H)**: $y=5, x \in [4, 10]$
*   **线段2 (V)**: $x=6, y \in [2, 12]$。交点 $(6,5)$。由于 $4 \leqslant 6 \leqslant 10$ 且 $2 \leqslant 5 \leqslant 12$，**相交**。
*   **线段3 (V)**: $x=8, y \in [3, 5]$。交点 $(8,5)$。由于 $4 \leqslant 8 \leqslant 10$ 且 $3 \leqslant 5 \leqslant 5$（端点接触），**相交**。
