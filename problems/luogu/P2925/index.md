...
**一句话本质**：每捆草体积同时充当重量和价值，求不超过容量 C 的最大总体积——01 背包当重量和价值相同时，用 bitset 做可行性 DP 比维护最大值更简洁。
...
这题和最基础的 0/1 背包完全同型，只是物品价值刚好等于物品体积。当重量和价值一致并且只需知道最大可达容量时，bitset 可行性 DP 比维护最大值更简洁高效。
