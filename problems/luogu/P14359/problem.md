...
见选手目录下的 $\textbf{\textit{xor/xor4.in}}$ 与 $\textbf{\textit{xor/xor4.ans}}$。

该样例满足测试点 $4, 5$ 的约束条件。

### 【样例 5】

见选手目录下的 $\textbf{\textit{xor/xor5.in}}$ 与 $\textbf{\textit{xor/xor5.ans}}$。

该样例满足测试点 $9, 10$ 的约束条件。

### 【样例 6】

见选手目录下的 $\textbf{\textit{xor/xor6.in}}$ 与 $\textbf{\textit{xor/xor6.ans}}$。
