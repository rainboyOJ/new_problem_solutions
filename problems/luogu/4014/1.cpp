...
int  build_and_solve(int mod) {
    ...
    s = 0;
    t = 2 *n + 1;
    mcmf.init(t); // 注意这里可能需要根据节点编号调整大小，例如 n+2
...
int main() {
    ...
    cout << build_and_solve(1) << "\n";
    cout << build_and_solve(2) << "\n";
