...
**Note**: The input file has a newline at the end of each line but does not have a "return". Sometimes, programmers code for the Windows paradigm of "return" followed by "newline"; do not do that. Use simple input routines like `readln` (for Pascal) and, for C/C++, `scanf` and `cin`.
